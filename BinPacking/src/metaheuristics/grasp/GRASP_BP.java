 ...
 */
public class GRASP_BP extends AbstractGRASP<Integer> {
	 ...
	 */
	public GRASP_BP(Double alpha, Integer iterations, String filename) throws IOException {
		super(new BP(filename), alpha, iterations);
	}
	...
	public ArrayList<Integer> makeCL() {
		...
		for (int i = 0; i < ObjFunction.getNumberOfItems(); i++) {
	...
	public Solution<Integer> createEmptySol() {
		...
		sol.cost = 0.0;
		for (int i = 0; i < ObjFunction.getNumberOfItems(); i++)
			for (int j = 0; j < ObjFunction.getNumberOfItems(); j++)
				sol.x[i][j] = 0;
		return sol;
	}
	...
	public static void main(String[] args) throws IOException {
		...
		GRASP_BP grasp = new GRASP_BP(0.05, 1000, "instances/qbf020");
